...
//
//	go build -ldflags "-X github.com/whiteCcinn/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/whiteCcinn/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
